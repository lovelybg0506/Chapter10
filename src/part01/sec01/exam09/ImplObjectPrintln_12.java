...
class ClassPrinter{
	...
	public static void print(Object obj) {	// 다형성, public String toString()
...
class Point {
	...
	public String toString() { //^^ Point클래스의 내가 만든 posInfo를 리턴하는 toString 메소드// Override
		String posInfo = "[x : "+xPos+",y: "+yPos+"]";
		
		return posInfo;
	}
}
public class ImplObjectPrintln_12 {
